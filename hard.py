...
def score_position(board, piece):                                  #Score Position
    score = 0
...
while not game_over:
            ...
            if turn == PLAYER:
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, PLAYER_PIECE):
                        label = myfont.render("Player Wins! Congrats!", 1, RED)
    ...
    if turn == AI and not game_over:
        ...
        # Initial Call 
        col, minimax_score = minimax(board, 4, -math.inf, math.inf, True)  # Here depth is 4
